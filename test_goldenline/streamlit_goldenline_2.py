...
with open('C:\\Users\\c.noel1\\OneDrive - STUDI\\Bureau\\test_goldenline\\database_2\\goldenline_client_2.csv', 'rb') as f:
    result1 = chardet.detect(f.read())
    

with open('C:\\Users\\c.noel1\\OneDrive - STUDI\Bureau\\test_goldenline\database_2\\goldenline_collecte_2.csv', 'rb') as f:
    result2 = chardet.detect(f.read())


df = pd.read_csv('C:\\Users\\c.noel1\\OneDrive - STUDI\\Bureau\\test_goldenline\\database_2\\goldenline_client_2.csv',encoding=result1['encoding'],sep =';|,')
df_collecte = pd.read_csv('C:\\Users\\c.noel1\OneDrive - STUDI\Bureau\\test_goldenline\database_2\\goldenline_collecte_2.csv',encoding = result2 ['encoding'],sep=';|,')
