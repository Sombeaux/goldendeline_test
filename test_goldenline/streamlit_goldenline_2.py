...
with open('C:\\Users\\c.noel1\\OneDrive - STUDI\\Bureau\\evalutation\\goldenline\\streamlit\\database\\goldenline_client.csv', 'rb') as f:
...
df = pd.read_csv('C:\\Users\\c.noel1\\OneDrive - STUDI\\Bureau\\evalutation\\goldenline\\streamlit\\database\\goldenline_client.csv',encoding=result1['encoding'],sep =';|,')
df_collecte = pd.read_csv('C:\\Users\\c.noel1\\OneDrive - STUDI\\Bureau\\evalutation\\goldenline\\streamlit\\database\\goldenline_collecte.csv',encoding = result2 ['encoding'],sep=';|,')
...
df_final['social_categorie'] = df_final['social_categorie'].astype(str)
